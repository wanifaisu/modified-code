...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        'scrollbar-thumb': '#000000',  // Black scrollbar thumb color
        'scrollbar-track': '#E2E8F0',  // Gray scrollbar track color
      ...
      backgroundImage: {
        ...
        linearGradient: "linear-gradient(90deg, #CCCCFF 0%, #CCCCFF 100%);"
      },
      content: {
